...
export function readData(key){
    ...
    if(key ==="folders"){
        ...
        if(folders === null){
            return  [{"type":"noFolder","contents":[{"name":"Templates","contents":["Page"],"type":"folder","status":"closed"},{"name":"Components","contents":["Modal","ResetPasswordModal","ForgotPassword"],"type":"folder","status":"closed"},{"name":"Elements","contents":["EmailInput","TermsAndService","SubmitButton","CancelButton","PrivacyAndPolicy","ResetPasswordForm","Form"],"type":"folder","status":"closed"}],"name":"noFolder","status":"open"}]
        }
        return folders;
    }
