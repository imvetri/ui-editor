...
function readData(key) {
    ...
    if (key === "folders") {
        ...
        var componentsNotInAnyFolder = componentNames.filter(function (componentName) {
            return folders.every(function (folder) {
                return folder.contents.every(function (content) {
        ...
        (_noFolder$contents = noFolder.contents).push.apply(_noFolder$contents, _toConsumableArray(componentsNotInAnyFolder));
        return folders;
    }
...
var Editor = function (_Component) {
    ...
    _createClass(Editor, [{
        ...
        value: function componentDidMount() {
            ...
            var editor = CodeMirror.fromTextArea(document.getElementById("elementMarkup"), config);
        }
    }, {
        key: "render",
        value: function render() {
