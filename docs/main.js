...
var _ResizableNodeSelected = __webpack_require__(42);
...
var ResizableNodeSelected = function ResizableNodeSelected(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactflow.Handle, { type: 'target', position: _reactflow.Position.Left }),
    _react2.default.createElement(
      'div',
      { style: { padding: 10 } },
      data.label
    ),
    _react2.default.createElement(_reactflow.Handle, { type: 'source', position: _reactflow.Position.Right })
  );
};
